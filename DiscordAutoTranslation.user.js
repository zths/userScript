...
unsafeWindow.GMDiscordTrsAppId = GM_getValue('GMDiscordTrsAppId') ? GM_getValue('GMDiscordTrsAppId') : "";
...
var engineFuncs = {
    ...
    Baidu:function (text,callback){
        ...
        var appid = unsafeWindow.GMDiscordTrsAppId;
        var key = unsafeWindow.GMDiscordTrsApiKey;
        var salt = "125637";
        ...
        +"&from="+encodeURIComponent(langPars[unsafeWindow.GMDiscordTrsFromLang])
        +"&to="+encodeURIComponent(langPars[unsafeWindow.GMDiscordTrsToLang])
...
(function() {
                ...
                if(args[0]){
                    ...
                    try{
                        ...
                        if(msg.content && msg.content.length > 1){
                            ...
                            engineFuncs[unsafeWindow.GMDiscordTrsEngine](msg.content,cb);
                            return true;
                        }
                    }catch(e){
                        console.error(e);
    ...
    function addCheckBoxInputGMSet(name,getValWrapFunc,setValWrapFunc){
        ...
        var EvFunc = (function(name){return function(){
    ...
    function toggleOptions(){
        ...
        var inputSplit = addTextInputGMSet("GMDiscordTrssplitStrDef", function(val){
